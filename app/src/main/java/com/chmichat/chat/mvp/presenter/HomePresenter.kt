...
import com.chmichat.chat.mvp.contract.HomeContract
import com.chmichat.chat.mvp.model.HomeModel
...
class HomePresenter : BasePresenter<HomeContract.View>(), HomeContract.Presenter {
    ...
    private var bannerlist:List<BannerBean>?=null
    ...
    override fun HomeBanner(map: Map<String, String>) {
        checkViewAttached()
        mRootView?.showLoading()
        val disposable = homeModel.myTestUrl(map)
                .subscribe({ issue ->
                    mRootView?.apply {
                        dismissLoading()

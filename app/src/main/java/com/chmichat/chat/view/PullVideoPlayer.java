...
public class PullVideoPlayer extends GSYVideoPlayer {
    ...
    public PullVideoPlayer(Context context) {
        super(context);
    }

    public PullVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void startPlayLogic() {
        if (mStandardVideoAllCallBack != null) {
            ...
            mStandardVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, PullVideoPlayer.this);
        }
        prepareVideo();
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            PullVideoPlayer gsyVideoPlayer = (PullVideoPlayer) gsyBaseVideoPlayer;
    ...
    private void initFullUI(PullVideoPlayer pullVideoPlayer) {
        ...
        if (mBottomProgressDrawable != null) {
            pullVideoPlayer.setBottomProgressBarDrawable(mBottomProgressDrawable);
        }

        if (mBottomShowProgressDrawable != null && mBottomShowProgressThumbDrawable != null) {
            pullVideoPlayer.setBottomShowProgressBarDrawable(mBottomShowProgressDrawable,
                    mBottomShowProgressThumbDrawable);
        }

        if (mVolumeProgressDrawable != null) {
            pullVideoPlayer.setDialogVolumeProgressBar(mVolumeProgressDrawable);
        }

        if (mDialogProgressBarDrawable != null) {
            pullVideoPlayer.setDialogProgressBar(mDialogProgressBarDrawable);
        }

        if (mDialogProgressHighLightColor >= 0 && mDialogProgressNormalColor >= 0) {
            pullVideoPlayer.setDialogProgressColor(mDialogProgressHighLightColor, mDialogProgressNormalColor);
        }
    }
